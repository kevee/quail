  ...
  var colors = {
    ...
    getColor : function(element, type) {
      ...
      if (!element.dataset('cacheId')) {
        element.dataset('cacheId', 'id_' + Math.random());
      }
      var cacheKey = 'getColor_' + type + '_' + element.dataset('cacheId');
      if (colors.cache[cacheKey] !== undefined) {
        return colors.cache[cacheKey];
      }
    ...
    getBackgroundImage: function(element) {
      ...
      var cacheKey = 'getBackgroundImage_' + element.dataset('cacheId');
      if (colors.cache[cacheKey] !== undefined) {
        return colors.cache[cacheKey];
      }
      element = element[0];
    ...
    getBackgroundGradient: function(element) {
      ...
      var cacheKey = 'getBackgroundGradient_' + element.dataset('cacheId');
      if (colors.cache[cacheKey] !== undefined) {
        return colors.cache[cacheKey];
      }
    ...
    traverseVisualTreeForBackground: function(element, property) {
      ...
      var cacheKey = 'traverseVisualTreeForBackground_' + element.dataset('cacheId') + '_' + property;
      if (colors.cache[cacheKey] !== undefined) {
        return colors.cache[cacheKey];
      }
